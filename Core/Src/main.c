...
int main(void)
{
  ...
  // AFSM_ctor(&myFSM);    							// myFSM.ctor
  // StateTable_init((StateTable*)&myFSM);				// myFSM.Init

  bFSM_ctor();
  QHsm_init(pbFSM, (void*)0);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : K2_Pin K3_Pin K0_Pin K1_Pin */
  GPIO_InitStruct.Pin = K2_Pin|K3_Pin|K0_Pin|K1_Pin;
